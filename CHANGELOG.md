...
- Fixed broken relative links in README and CHANGELOG for npm website compatibility.
- Updated repository URLs to point to `synpulse8-opensource`.
...
- **Detailed Documentation** - Refactored guides including a new dedicated [Advanced Streaming](https://github.com/synpulse8-opensource/pulse8-react-frontend-component-for-k8/blob/main/docs/STREAMING.md) guide.
...
[0.3.1]: https://github.com/synpulse8-opensource/pulse8-react-frontend-component-for-k8/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/synpulse8-opensource/pulse8-react-frontend-component-for-k8/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/synpulse8-opensource/pulse8-react-frontend-component-for-k8/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/synpulse8-opensource/pulse8-react-frontend-component-for-k8/releases/tag/v0.1.0
